...
const CartItemBlock: React.FC<CartItemProps> = ({
  ...
  const onClickPlus = (event: React.MouseEvent<HTMLButtonElement>) => {
    dispatch(
      addItem({
        id,
      } as CartItem),
  ...
  const onClickMinus = (event: React.MouseEvent<HTMLButtonElement>) => {
    dispatch(minusItem(id));
  };

  const onClickRemove = (event: React.MouseEvent<HTMLDivElement>) => {
